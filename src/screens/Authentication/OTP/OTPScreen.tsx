    ...
    <SafeAreaView style={[globalStyles.container, screenStyles.container]}>
      ...
      >
        ...
        <View style={screenStyles.content}>
          {/* Security Icon */}
          <View style={[screenStyles.iconContainer, { backgroundColor: colors.background.otpIcon }]}>
            <AppIcon name="shield" size={56} color={colors.brand.canonBlue} />
          </View>
          ...
          <AppText
            variant="inputText"
            style={[screenStyles.instructions, { color: colors.text.sectionHeader }]}
          >
            Please enter the 6-digit verification code sent to your registered dealer mobile number ending in{' '}
            <AppText
              variant="inputText"
              style={[screenStyles.phoneNumber, { color: colors.brand.canonBlue, fontWeight: '600' }]}
            >
              {phone}.
            </AppText>
          </AppText>
          ...
          <View style={screenStyles.resendContainer}>
            <AppText
              variant="inputText"
              style={[screenStyles.resendQuestion, { color: colors.text.sectionHeader }]}
            >
            ...
            >
              <AppIcon
                name="refresh"
                size={16}
                color={canResend ? colors.brand.canonBlue : colors.text.timer}
            ...
            {!canResend && (
              <AppText
                variant="inputText"
                style={[screenStyles.timerText, { color: colors.text.timer }]}
              >
